...
const nav = [
  ...
  { group:'GENLAYER INTELLIGENCE', items:[
    ...
    { id:'contract', label:'GenLayer Contract', icon:Layers3 },
...
export default function Page(){
  ...
  return <main className="min-h-screen bg-[#05070d] grid-bg text-slate-100 overflow-x-hidden">
    <aside className="fixed inset-y-0 left-0 w-[250px] bg-[#070b15]/95 border-r border-slate-800 p-4 overflow-y-auto z-30">
      <div className="flex items-center gap-3 mb-7"><img src="/genlayer-studio-logo.png" alt="GenLayer finance studio" className="h-16 w-16 rounded-2xl object-cover border border-amber-400/30 shadow-3d"/><div><h1 className="text-2xl font-black leading-tight">GenLayer Studio</h1><p className="text-xs text-cyan-100/60">Intelligent Finance OS</p></div></div>
